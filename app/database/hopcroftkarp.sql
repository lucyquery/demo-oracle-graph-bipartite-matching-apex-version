...
public class HopcroftKarp {
    ...
    public static oracle.sql.ARRAY runMatching(ResultSet rs) throws SQLException {
        ...
        StructDescriptor structDesc = StructDescriptor.createDescriptor("<SCHEMA_NAME>.INT_ARRAY_ROW", conn);
        ArrayDescriptor  arrayDesc  = ArrayDescriptor.createDescriptor("<SCHEMA_NAME>.INT_ARRAY_TABLE", conn);
